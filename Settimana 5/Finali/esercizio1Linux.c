/*
    ...
    * Versione compatibile con Linux
    * In alcune architetture la funzione sleep() potrebbere richiedere millisecondi come argomento e non secondi
...
#include <time.h>
#include <unistd.h>
#define ROW 60 // Definisco il numero di righe della matrix
#define COL 170 // Definisco il numero di colonne della matrix
...
int main()
{
    ...
    sleep(1); // Pauso per un secondo il programma
    system("clear"); // Pulisco lo schermo - Compatibile solo con Windows
    ...
    while (k <= number) {
        ...
        // Se un tasto qualsiasi viene premuto, la funzione kbhit restituisce un valore non nullo, altrimenti restituisce 0
        sleep(1);
        system("clear"); // Compatibile solo con Windows
